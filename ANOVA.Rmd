...
* define the Fisher's and Welch's residuals by substracting the mean of each group to the weight loss of the corresponding participants 
* define the Kruskal's residual's by substraction the median of each group to the weight loss of the corresponding participants 
...
The file *globalBreastCancerRisk.csv* gives the number of new cases of Breast Cancer (per population of 10,000) in various countries around the world, along with various health and lifestyle risk factors. These data were collected from the gapminder resource 1. 
...
Visualise the distribution of breast cancer incidence in each continent. Check how many observations belong to each group (continent). Are there any groups that you would consider removing/groupinf before performing the analysis ? 
