...
<!--- rmarkdown::render("/Volumes/Files/courses/cruk/LinearModelAndExtensions/20210312/Practicals/ANOVA.Rmd") --->

```{r message = FALSE, warning = FALSE, echo = FALSE} 
# change working directory: should be the directory containg the Markdown files:
# setwd("/Volumes/Files/courses/cruk/LinearModelAndExtensions/20210312/Practicals/")
