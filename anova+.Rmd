...
<!--- rmarkdown::render("~/courses/cruk/LinearModelAndExtensions/20200310/Practicals/ANOVA+.Rmd") --->

```{r message = FALSE, warning = FALSE, echo = FALSE} 
# change working directory: should be the directory containg the Markdown files:
setwd("~/courses/cruk/LinearModelAndExtensions/20200310/Practicals/")
...
```{r message = FALSE, warning = FALSE, echo = TRUE} 
breastcancer = read.csv("data/globalBreastCancerRisk.csv")
